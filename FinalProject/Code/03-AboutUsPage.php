...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav" style="background-color: #0f151a;"></div>

    <div class="col-sm-8 text-left" style="padding: 0 1em 2em 1em;"> 
      <p class="center" style="letter-spacing: 2px; line-height: 150%;">Cackle is a merchandise company that focuses on distributing fandom related merch that may come from video games, music, animation, series, and much more! We aim to open the opportunities for artists to express their creativity and share it to people with similar interests!</p><br>
